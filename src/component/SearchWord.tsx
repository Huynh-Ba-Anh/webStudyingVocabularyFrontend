    ...
    return (
        <div className="flex flex-col items-center gap-4 mb-6">
            ...
            <div className="relative w-full max-w-xs">
                ...
                />
                <button
                    onClick={() => speakWord(term, "en")}
                    className="absolute right-1 top-1/2 -translate-y-1/2 h-8 w-8 flex items-center justify-center rounded-full bg-blue-300 text-white shadow hover:bg-blue-600 transition"
                    title="Phát âm"
                >
                    🔊
                </button>
            ...
            {data && (
                <div className="mt-4 w-full max-w-md rounded-xl border border-gray-200 bg-gray-50 p-5 shadow-md space-y-3">
                    <div className="flex justify-between items-center">
                        ...
                        {data.phonetic && (
                            <span className="text-gray-500 italic">{data.phonetic}</span>
                        )}
                    </div>
                    ...
                    {data.meaning_vi && (
                        <p className="rounded-md bg-blue-50 px-3 py-1 text-blue-600 font-medium">
                            👉 {data.meaning_vi}
                            <button
